    ...
    <div className="flex flex-col items-center justify-start min-h-screen py-8 px-4">
      ...
      <div className="max-w-2xl w-full mx-auto mt-8 space-y-6">
        ...
        <div 
          ...
          className={`relative overflow-hidden bg-black/30 backdrop-blur-sm border ${characterResults ? 'border-green-500/30' : 'border-purple-500/30'} rounded-xl p-6 cursor-pointer hover:bg-black/40 transition-all group`}
        >
        ...
        <div 
          ...
          className={`relative overflow-hidden bg-black/30 backdrop-blur-sm border ${drinkingHabitResults ? 'border-green-500/30' : 'border-purple-500/30'} rounded-xl p-6 cursor-pointer hover:bg-black/40 transition-all group`}
        >
          <div className="flex items-start gap-4">
