...
const questions: Record<number, Question> = {
    ...
    2: {
        ...
        {
            name: "ビール",
            subtypes: ["生ビール", "クラフトビール", "ラガービール", "エール", "フルーツビール", "黒ビール", "シャンディガフ", "レッドアイ"]
        },
        {
            name: "ワイン",
            subtypes: ["赤ワイン", "白ワイン", "ロゼワイン", "シャンパン", "サングリア"]
        },
        {
            name: "日本酒",
            subtypes: ["日本酒(辛口)", "日本酒(甘口)", "にごり酒", "甘酒", "スパークリング日本酒", "熱燗"]
        },
        {
            name: "焼酎",
            subtypes: ["芋焼酎", "麦焼酎", "米焼酎", "黒糖焼酎"]
        },
        {
            name: "ウイスキー",
            subtypes: ["スコッチ派","バーボン派", "アイリッシュ", "ジャパニーズ", "カナディアンウィスキー", "ハイボール"]
        },
        {
            name: "カクテル",
            subtypes: ["カクテル", "ジン系", "ウォッカ系", "ラム系", "テキーラ系","リキュール系"]
        },
        {
            name: "居酒屋定番メニュー",
            subtypes: [
